...
var ReactAce = (function(_Component) {
  ...
  function ReactAce(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (ReactAce.__proto__ || Object.getPrototypeOf(ReactAce)).call(this, props)
    );
  ...
  _createClass(ReactAce, [
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        if (
          !(0, _lodash2.default)(nextProps.annotations, oldProps.annotations)
        ) {
          this.editor.getSession().setAnnotations(nextProps.annotations || []);
        }
        if (
          !(0, _lodash2.default)(nextProps.markers, oldProps.markers) &&
        ...
        if (
          !(0, _lodash2.default)(nextProps.scrollMargin, oldProps.scrollMargin)
        ) {
