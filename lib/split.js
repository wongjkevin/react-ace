...
var SplitComponent = (function(_Component) {
  ...
  function SplitComponent(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (SplitComponent.__proto__ || Object.getPrototypeOf(SplitComponent)).call(
        this,
        props
      )
    );
  ...
  _createClass(SplitComponent, [
    {
      ...
      value: function componentDidMount() {
        ...
        split.forEach(function(editor, index) {
          ...
          var defaultValueForEditor = (0, _lodash4.default)(
            defaultValue,
            index
          );
          ...
          editor
            .getSession()
            .selection.on("changeSelection", _this2.onSelectionChange);
          editor
            .getSession()
            .selection.on("changeCursor", _this2.onCursorChange);
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        split.forEach(function(editor, index) {
          ...
          if (
            !(0, _lodash2.default)(nextProps.setOptions, oldProps.setOptions)
          ) {
          ...
          var newAnnotations = (0, _lodash4.default)(
            nextProps.annotations,
            index,
            []
          );
          var oldAnnotations = (0, _lodash4.default)(
            oldProps.annotations,
            index,
            []
          );
          ...
          if (
            !(0, _lodash2.default)(newMarkers, oldMarkers) &&
...
SplitComponent.propTypes = {
  ...
  enableBasicAutocompletion: _propTypes2.default.oneOfType([
    _propTypes2.default.bool,
    _propTypes2.default.array
  ]),
  enableLiveAutocompletion: _propTypes2.default.oneOfType([
    _propTypes2.default.bool,
    _propTypes2.default.array
  ]),
